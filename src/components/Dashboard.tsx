          ...
          <Card className="p-4 hover:shadow-lg transition-all cursor-pointer bg-gradient-to-br from-[#1A1F2C]/10 to-[#1A1F2C]/5 backdrop-blur-sm border border-[#1A1F2C]/20">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#1A1F2C]">R$ 72.000,00</p>
                <p className="text-xs text-success-DEFAULT">+8% vs. mês anterior</p>
              </div>
              <div className="bg-[#1A1F2C]/20 p-3 rounded-full">
                <ArrowUp className="w-6 h-6 text-[#1A1F2C]" />
              </div>
            </div>
          </Card>

          <Card className="p-4 hover:shadow-lg transition-all cursor-pointer bg-gradient-to-br from-[#403E43]/10 to-[#403E43]/5 backdrop-blur-sm border border-[#403E43]/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Despesas Totais</p>
                <p className="text-2xl font-bold text-[#403E43]">R$ 65.000,00</p>
                <p className="text-xs text-danger-DEFAULT">+5% vs. mês anterior</p>
              </div>
              <div className="bg-[#403E43]/20 p-3 rounded-full">
                <ArrowDown className="w-6 h-6 text-[#403E43]" />
              </div>
            </div>
          </Card>
          ...
          <Card className="p-4 hover:shadow-lg transition-all cursor-pointer bg-gradient-to-br from-[#403E43]/10 to-[#403E43]/5 backdrop-blur-sm border border-[#403E43]/20">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#403E43]">R$ 45.750,00</p>
                <p className="text-xs text-success-DEFAULT">157 vendas no mês</p>
              </div>
              <div className="bg-[#403E43]/20 p-3 rounded-full">
                <Banknote className="w-6 h-6 text-[#403E43]" />
              </div>
            </div>
          </Card>
          ...
          <Card className="p-4 hover:shadow-lg transition-all cursor-pointer bg-gradient-to-br from-[#1EA5E9]/10 to-[#1EA5E9]/5 backdrop-blur-sm border border-[#1EA5E9]/20">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#1EA5E9]">R$ 291,40</p>
                <p className="text-xs text-warning-DEFAULT">-2% vs. mês anterior</p>
              </div>
              <div className="bg-[#1EA5E9]/20 p-3 rounded-full">
                <ChartBar className="w-6 h-6 text-[#1EA5E9]" />
              </div>
            </div>
          </Card>
        </div>
