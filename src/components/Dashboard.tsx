...
const Dashboard = () => {
  return (
    <div className="p-3 md:p-6 space-y-4 md:space-y-6 animate-fade-in">
      ...
      {/* KPIs - Financeiro */}
      <div>
        <h2 className="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#6366F1] flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <Card className="col-span-1 lg:col-span-2 p-4 md:p-6 bg-gradient-to-br from-white/80 to-white/50 backdrop-blur-sm border border-[#6366F1]/20">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 gap-2 md:gap-0">
            <div>
