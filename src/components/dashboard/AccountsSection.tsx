import { AlertTriangle, Clock, CreditCard, PiggyBank, Sun, Moon } from "lucide-react";
...
export const AccountsSection = () => {
  ...
  const getCardClassName = (baseColor: string) => {
    ...
    return cardStyle === "solid"
      ? `${baseClasses} ${baseColor} border-none`
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
        <Card className={getCardClassName("emerald-500")}>
          <div className="flex items-center justify-between">
            ...
            <div className={cardStyle === "solid" ? "bg-white/20" : "bg-emerald-100"}>
        ...
        <Card className={getCardClassName("rose-500")}>
          <div className="flex items-center justify-between">
            ...
            <div className={cardStyle === "solid" ? "bg-white/20" : "bg-rose-100"}>
        ...
        <Card className={getCardClassName("blue-500")}>
          <div className="flex items-center justify-between">
            ...
            <div className={cardStyle === "solid" ? "bg-white/20" : "bg-blue-100"}>
