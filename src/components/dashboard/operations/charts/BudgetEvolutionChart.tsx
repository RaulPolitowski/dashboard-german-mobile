...
const pieData = [
  { name: 'Aprovados', value: 45, valor: 320000 },
  { name: 'Pendentes', value: 15, valor: 98000 },
  { name: 'Recusados', value: 8, valor: 45000 },
];
      ...
      <ResponsiveContainer width="100%" height="100%">
        <PieChart>
          <Pie
            ...
            cy="50%"
            labelLine={false}
            label={({ name, value, valor }) => `${name}: ${value} (${formatCurrency(valor)})`}
            outerRadius={100}
            fill="#8884d8"
            dataKey="value"
          >
